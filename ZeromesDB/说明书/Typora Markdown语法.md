...
**Markdown** is created by [Daring Fireball](http://daringfireball.net/); the original guideline is [here](http://daringfireball.net/projects/markdown/syntax). Its syntax, however, varies between different parsers or editors. **Typora** is using [GitHub Flavored Markdown][GFM]. ^2b1c68
...
Markdown supports two styles of links: inline and reference. ^4276e8

In both styles, the link text is delimited by [square brackets]. ^linkDelimitation
